...
url = "http://59.162.178.178:3000/device/smart-city?id="
def send_to_cloud(id,dust,alcohol,rms_current,acceleration_xout,acceleration_yout,acceleration_zout,Gyroscop_xout,Gyroscop_yout,Gyroscop_zout,x_rotation,y_rotation,magnetic,motion,ultra_sonic,sensor_value,ir_sensor,fire):
        data = json.dumps([
...
while True:
    try:
        ...
        print("Ultra-sonic sensor = ",ultra_sonic)
        print("---------------------")
        print("")
        ...
        print("---------------------")
        print("")
        print("please swipe the RFID card")
...
##        RFID reader
        ...
        send_to_cloud(id,dust,alcohol,rms_current,acceleration_xout,acceleration_yout,acceleration_zout,Gyroscop_xout,Gyroscop_yout,Gyroscop_zout,x_rotation,y_rotation,magnetic,motion,ultra_sonic,sensor_value,ir_sensor,fire)
